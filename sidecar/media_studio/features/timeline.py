...
# --------------------------------------------------------------------------- #
def build_peaks_argv(in_path: str, out_path: str, settings: dict[str, Any] | None = None) -> list[str]:
...
class Timeline:
    ...
    def __init__(
        ...
        *,
        ...
        peaks_dir: str | os.PathLike | None = None,
        run: RunFn | None = None,
    ...
    def _read_cache(self, video_id: str, in_path: str, mtime_ns: int) -> dict[str, Any] | None:
    ...
    def _write_cache(self, video_id: str, in_path: str, mtime_ns: int, result: dict[str, Any]) -> None:
    ...
    def _decode_pcm(self, in_path: str, settings: dict[str, Any]) -> bytes:
        ...
        fd, tmp_name = tempfile.mkstemp(prefix="peaks-", suffix=".pcm", dir=str(self._peaks_dir))
        ...
        try:
            ...
            if code != 0:
                raise RpcError(
                    f"ffmpeg exited with code {code} decoding audio peaks for {in_path} (no decodable audio stream?)",
