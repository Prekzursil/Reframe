...
> **Status:** ARCHIVED 2026-08-08 — every `handlers.py:NNN` and `lib/rpc.ts:NNN` anchor in this file is dead; both are packages now. Historical only.

Completeness critic sweep of the whole tree against **CONTRACTS.md (base + P2 addendum)** and
**docs/_archive/2026-06/PLAN-P2.md v2.1**. Both suites were RUN (not just read): sidecar `1089 passed / 2 failed`,
