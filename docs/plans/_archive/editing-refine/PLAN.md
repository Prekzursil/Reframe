...
> **Status:** SUPERSEDED BY docs/plans/v1.5/SCOPE.md (2026-08-08) — shipped in `sidecar/media_studio/features/refine.py`; the RPC doctrine here is replaced by `docs/rpc-contract-v2.md`. Historical only.

**Status:** PLAN (docs only; no feature code). Follows the gate-approved DESIGN at
`docs/plans/_archive/editing-refine/DESIGN.md`.
...
- **Goal:** confirm working branch `feat/editing-refine-design`; create empty
  `docs/plans/_archive/editing-refine/PLAN.md` (this file) and the test-file placeholders'
  directory expectations. No source changes.
- **Files:** `docs/plans/_archive/editing-refine/PLAN.md` (this commit).
