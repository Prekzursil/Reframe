...
> **Status:** SUPERSEDED BY docs/plans/v1.5/SCOPE.md (2026-08-08) — shipped in `sidecar/media_studio/job_store.py`; the RPC doctrine here is replaced by `docs/rpc-contract-v2.md`. Historical only.
