...
> **Status:** SUPERSEDED BY docs/plans/v1.5/SCOPE.md (2026-08-08) — shipped in `sidecar/media_studio/models/catalog.py`; the RPC doctrine here is replaced by `docs/rpc-contract-v2.md`. Historical only.
...
- **G6 (docs):** in-app tooltips on every badge + a 4-step tutorial; standalone `docs/providers/MODEL-GUIDE.md` + `docs/providers/SETUP.md` shipped.
