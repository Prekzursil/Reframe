...
> **Status:** SUPERSEDED BY docs/plans/v1.5/SCOPE.md (2026-08-08) — shipped in `sidecar/media_studio/features/batch.py`; the RPC doctrine here is replaced by `docs/rpc-contract-v2.md`. Historical only.

**Status:** v1 — PLAN (derived from `docs/plans/_archive/repurpose/DESIGN.md`, design-gate passed after revision)
**Date:** 2026-06-18
