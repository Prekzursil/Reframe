...
> **Status:** SUPERSEDED BY docs/plans/v1.5/SCOPE.md (2026-08-08) — shipped in `sidecar/media_studio/features/recommender.py`; the RPC doctrine here is replaced by `docs/rpc-contract-v2.md`. Historical only.
...
> Companion to `docs/plans/_archive/intelligence/DESIGN.md` (commit `2409de0`, blockers resolved `a2eeb67`).
