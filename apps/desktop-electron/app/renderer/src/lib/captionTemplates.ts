...
export const REMOTION_CAPTION_TEMPLATES: Record<string, CaptionTemplateVisual> = {
  bold: {
    id: 'bold', engine: 'remotion',
    textColor: '#FFFFFF', activeColor: '#FFD700', spokenColor: '#FFFFFF',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: '#000000',
    fontFamily: "'Montserrat', sans-serif", position: 'bottom', uppercase: true, box: false, outline: false,
  },
  karaoke: {
    id: 'karaoke', engine: 'remotion',
    textColor: '#FFFFFF', activeColor: '#FFD700', spokenColor: '#00E5FF',
    backgroundColor: 'transparent', activeBackground: 'rgba(0, 0, 0, 0.55)', shadowColor: '#000000',
    fontFamily: "'Montserrat', sans-serif", position: 'bottom', uppercase: false, box: false, outline: false,
  },
  clean: {
    id: 'clean', engine: 'remotion',
    textColor: '#FFFFFF', activeColor: '#E0E0E0', spokenColor: '#FFFFFF',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: 'rgba(0, 0, 0, 0.6)',
    fontFamily: "'Inter', sans-serif", position: 'bottom', uppercase: false, box: false, outline: false,
  },
  bounce: {
    id: 'bounce', engine: 'remotion',
    textColor: '#00FFFF', activeColor: '#FF00FF', spokenColor: '#00FFFF',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: '#000000',
    fontFamily: "'Bangers', cursive", position: 'bottom', uppercase: true, box: false, outline: false,
  },
  hormozi: {
    id: 'hormozi', engine: 'remotion',
    textColor: '#FFFFFF', activeColor: '#22E84F', spokenColor: '#FFFFFF',
    backgroundColor: 'rgba(0, 0, 0, 0.85)', activeBackground: 'rgba(0, 0, 0, 0.85)', shadowColor: '#000000',
    fontFamily: "'Montserrat', sans-serif", position: 'center', uppercase: true, box: true, outline: false,
  },
  neon: {
    id: 'neon', engine: 'remotion',
    textColor: '#39FF14', activeColor: '#FF00E5', spokenColor: '#39FF14',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: '#0A0033',
    fontFamily: "'Montserrat', sans-serif", position: 'bottom', uppercase: true, box: false, outline: true,
  },
  tiktok: {
    id: 'tiktok', engine: 'remotion',
    textColor: '#FFFFFF', activeColor: '#FE2C55', spokenColor: '#FFFFFF',
    backgroundColor: '#000000', activeBackground: 'transparent', shadowColor: 'transparent',
    fontFamily: "'Inter', sans-serif", position: 'bottom', uppercase: false, box: true, outline: false,
  },
  gradient: {
    id: 'gradient', engine: 'remotion',
    textColor: '#FF6B6B', activeColor: '#C77DFF', spokenColor: '#FFD93D',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: '#1A0030',
    fontFamily: "'Montserrat', sans-serif", position: 'center', uppercase: true, box: false, outline: false,
  },
  impact: {
    id: 'impact', engine: 'remotion',
    textColor: '#FFFFFF', activeColor: '#FFEB3B', spokenColor: '#FFFFFF',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: '#000000',
    fontFamily: "'Montserrat', sans-serif", position: 'center', uppercase: true, box: false, outline: true,
  },
  mrbeast: {
    id: 'mrbeast', engine: 'remotion',
    textColor: '#FFFFFF', activeColor: '#FFE000', spokenColor: '#FFFFFF',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: '#C20000',
    fontFamily: "'Montserrat', sans-serif", position: 'top', uppercase: true, box: false, outline: true,
  },
  pop: {
    id: 'pop', engine: 'remotion',
    textColor: '#FF4D9D', activeColor: '#9B5DE5', spokenColor: '#36E2EC',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: '#2B0040',
    fontFamily: "'Bangers', cursive", position: 'center', uppercase: false, box: false, outline: false,
  },
  serif: {
    id: 'serif', engine: 'remotion',
    textColor: '#F5EFE0', activeColor: '#E8C547', spokenColor: '#F5EFE0',
    backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: 'rgba(0, 0, 0, 0.7)',
    fontFamily: "Georgia, 'Times New Roman', serif", position: 'bottom', uppercase: false, box: false, outline: false,
  },
  subtitle: {
    id: 'subtitle', engine: 'remotion',
    textColor: '#FFFFFF', activeColor: '#FFFFFF', spokenColor: '#FFFFFF',
    backgroundColor: 'rgba(0, 0, 0, 0.6)', activeBackground: 'transparent', shadowColor: 'transparent',
    fontFamily: "'Inter', sans-serif", position: 'bottom', uppercase: false, box: true, outline: false,
  },
  fire: {
    id: 'fire', engine: 'remotion',
    textColor: '#FFE0B2', activeColor: '#FFEB3B', spokenColor: '#FF3D00',
    backgroundColor: 'transparent', activeBackground: 'rgba(60, 0, 0, 0.6)', shadowColor: '#3E0000',
    fontFamily: "'Montserrat', sans-serif", position: 'center', uppercase: true, box: false, outline: false,
  },
};
...
const LIBASS_VISUAL: CaptionTemplateVisual = {
  id: 'libass', engine: 'libass',
  textColor: '#FFFFFF', activeColor: '#FFD700', spokenColor: '#FFFFFF',
  backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: DEFAULT_SHADOW,
  fontFamily: "'Inter', sans-serif", position: 'bottom', uppercase: false, box: false, outline: false,
};

/** none — overlay is a no-op (no captions); kept for completeness/superset. */
const NONE_VISUAL: CaptionTemplateVisual = {
  id: 'none', engine: 'libass',
  textColor: 'transparent', activeColor: 'transparent', spokenColor: 'transparent',
  backgroundColor: 'transparent', activeBackground: 'transparent', shadowColor: 'transparent',
  fontFamily: "'Inter', sans-serif", position: 'bottom', uppercase: false, box: false, outline: false,
};
