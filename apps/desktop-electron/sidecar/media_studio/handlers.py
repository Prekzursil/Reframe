...
class Services:
    ...
    def __init__(
        ...
        *,
        ...
        library: Optional[_library.Library] = None,
        whisper_loader: Optional[Any] = None,
        ffmpeg_run: Optional[Callable[..., int]] = None,
        ffprobe_duration: Optional[Callable[..., float]] = None,
        reframe_runner: Optional[Callable[..., Any]] = None,
        silence_run: Optional[Callable[..., Any]] = None,
        scene_detector: Optional[Callable[[str], Any]] = None,
    ...
    # resolvers
    # ===================================================================== #
    def _resolve_video_path(self, video_id: str) -> Optional[str]:
    ...
    def tracks_burn(self, params: Dict[str, Any], ctx: RpcContext) -> Dict[str, Any]:
        ...
        def job_body(job_ctx: Any) -> Dict[str, Any]:
            path = _tracks.burn_track(
                in_path, track, settings=settings, ctx=job_ctx, run=run, duration=probe,
            )
            return {"path": path}
    ...
    def _detect_boundaries(self, video_id: str) -> Dict[str, Any]:
        ...
        silences = _boundary.detect_silences(
            path, settings=self.settings.get(), run=self._silence_run
        )
    ...
    def _dub_translator(self) -> Any:
        ...
        class _DubTranslator:
            def translate(
                ...
                cues = [
                    {"index": i + 1, "start": 0.0, "end": 0.0, "text": str(t)}
