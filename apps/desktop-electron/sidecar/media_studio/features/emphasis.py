...
KEYWORDS: frozenset[str] = frozenset(
    {
        "free", "now", "new", "secret", "secrets", "best", "worst", "never",
        "always", "stop", "warning", "huge", "massive", "crazy", "insane",
        "amazing", "incredible", "shocking", "money", "rich", "million",
        "billion", "win", "winning", "instantly", "fast", "easy", "proven",
        "guaranteed", "first", "last", "only", "everyone", "nobody", "everything",
        "nothing", "love", "hate", "danger", "dangerous", "important", "must",
        "ultimate", "exclusive", "viral", "boom", "fire", "growth", "hack",
        "mistake", "mistakes", "truth", "real", "biggest", "powerful", "power",
    }
)
...
def default_emphasis_for_style(style: Optional[str]) -> bool:
...
def resolve_emphasis(settings: Optional[Mapping[str, Any]]) -> bool:
...
def normalize_spans(raw: Any, text_len: Optional[int] = None) -> List[Dict[str, Any]]:
