...
def build_logo_overlay_filter(
    *,
    ...
    logo_scale_pct: Optional[float] = None,
) -> str:
...
def build_logo_overlay_argv(
    ...
    *,
    ...
    filter_complex = build_logo_overlay_filter(
        corner=corner, padding=padding, logo_scale_pct=logo_scale_pct
    )
    return [
