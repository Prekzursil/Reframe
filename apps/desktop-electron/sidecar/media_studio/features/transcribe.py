...
VideoResolver = Callable[[str], Optional[str]]
...
def make_transcribe_handler(
    ...
    *,
    loader: Optional[WhisperLoader] = None,
    on_transcribed: Optional[TranscribedHook] = None,
):
    ...
    *,
    ...
    protocol.register(
        ...
        make_transcribe_handler(
            resolve_video, loader=loader, on_transcribed=on_transcribed
        ),
    )
